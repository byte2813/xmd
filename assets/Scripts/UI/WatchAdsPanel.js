...
var WatchAdsPanel = cc.Class({
    ...
    ClickBtn:function(){
    	...
    	{
            if(cc.Mgr.global.hasActiveAiShen)
                return;
    	...
    	{
            if(cc.Mgr.global.hasActiveDuShen)
                return;
            var self = this;
    	...
    	{
            if(cc.Mgr.global.hasActiveGuShen)
                return;
            var self = this;
    	...
    	{
            if(cc.Mgr.global.hasActiveCaiShen)
                return;
